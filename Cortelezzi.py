...
plt.scatter(om_ana[:,0]/om_0, -om_ana[:,1]/om_0, s = 20, c = Oh_list, cmap=mymap, norm=matplotlib.colors.LogNorm())
plt.xlabel('$\omega_{relax}/\omega_0 = \Re(\frac{s}{\omega_0})$', family = "Roboto", weight="ultralight")      
plt.ylabel('$\omega_{osc}/\omega_0 = \Im(\frac{s}{\omega_0})$', family = "Roboto", weight="ultralight")
