...
& - \frac{\nu}{s}\frac{4\lambda k \sinh(kh)\left(ke^{-\lambda h}\left(k \cosh(kh) + \lambda \sinh(kh)\right)-\left(k^2+\lambda^2\right)\right)+\left(k^2+\lambda^2\right)^2\sinh(\lambda h)}{2k\cosh(kh)\left(k\cosh(kh)\sinh(\lambda h)-\lambda\cosh(\lambda h)\sinh(kh)\right)}
\end{split}
\end{equation}
