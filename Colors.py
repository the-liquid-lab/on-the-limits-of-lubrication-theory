...
# This file contains all the definitions for colors and colormaps used in the
#Pyhon file Cortelezzi.py. (Most material colors are defined in Rougier's book)
